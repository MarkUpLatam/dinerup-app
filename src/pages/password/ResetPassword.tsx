...
export default function ResetPassword() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setStatus("success");
      setMessage(typeof res === "string" ? res : "Contrasena actualizada");
      setTimeout(() => navigate("/"), 1500);
    } catch (e) {
      setStatus("error");
      setMessage(getErrorMessage(e, "No se pudo actualizar la contrasena."));
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white shadow-xl p-6 border border-neutral-100">
        <h1 className="text-2xl font-bold mb-2">Restablecer contrasena</h1>
        ...
        {message && (
          <div
            className={`mt-4 p-3 rounded-r-lg border-l-4 ${
              status === "success"
